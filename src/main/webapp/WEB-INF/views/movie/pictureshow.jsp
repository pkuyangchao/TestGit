...
<title>图片展示</title>
<link href="${APP_PATH }/static/manage/lib/lightbox2/2.8.1/css/lightbox.css" rel="stylesheet" type="text/css" >
</head>
<body>
		...
		<ul class="cl portfolio-area">
			<li class="item">
				<div class="portfoliobox">
					...
					<div class="picbox"><a href="temp/big/keting.jpg" data-lightbox="gallery" data-title="客厅1"><img src="${APP_PATH }${movie.movieImg }"></a></div>
					<div class="textbox">${movie.movieName }</div>
				</div>
			</li>
		</ul>
	</div>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${APP_PATH }/static/manage/lib/lightbox2/2.8.1/js/lightbox.min.js"></script> 
