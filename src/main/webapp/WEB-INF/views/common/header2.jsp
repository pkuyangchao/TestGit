											...
											<li>
												<div class="col-sm-4">
													<ul class="multi-column-dropdown">
														<li><a href="movieall?typekey=1">动作</a></li>
										...
										<div class="col-sm-6">
											<ul class="eb-ucenter-layer-main">
												<li class="eb-ucenter-layer-item">
													...
													<li class="eb-ucenter-layer-item">
													<a class="item-icon" type="post" href="userlogout">退出</a>
												</li>
											</ul>
										</div>
										<div class="clearfix"></div>
