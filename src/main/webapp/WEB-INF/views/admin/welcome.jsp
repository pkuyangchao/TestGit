...
<script type="text/javascript">
       window.onload=function(){
           setInterval(function(){
               ...
               d.innerHTML='系统时间：'+year+'年'+mon+'月'+da+'日'+'星期'+day+' '+h+':'+m+':'+s;
           },1000)
       }
   </script>   
<title>我的桌面</title>
...
<div class="page-container">
	<p class="f-20 text-success">欢迎<span class="f-10">${adminSession.adminAccount }</span>登录！</p>
	<p>登录次数：18 </p>
	...
	<table class="table table-border table-bordered table-bg mt-20">
		...
		<tbody>
			...
			<tr>
				<td>服务器域名</td>
				<td>${hostProperties.computerDomain }</td>
			</tr>
			<tr>
				<td>服务器端口 </td>
				<td>80</td>
			...
			<tr>
				<td>本文件所在文件夹 </td>
				<td>${hostProperties.userdir }</td>
			</tr>
			<tr>
				<td>服务器操作系统 </td>
				<td>${hostProperties.osName }</td>
			</tr>
			<tr>
				<td>系统所在文件夹 </td>
			...
			<tr>
				<td>服务器的语言种类 </td>
				<td>${hostProperties.hostLanguage }</td>
			</tr>
			
			<tr>
				<td>服务器当前时间 </td>
				<td>${hostProperties.osDate }</td>
			</tr>
			<tr>
				<td>服务器IE版本 </td>
				<td>6.0000</td>
...
if (remote_ip_info.ret == '1') {
    ...
    d.innerHTML= '当前地理位置：国家：' + remote_ip_info.country + '  省：' + remote_ip_info.province + '  市：' + remote_ip_info.city
} else {
alert('没有找到匹配的IP地址信息！');
}
});
