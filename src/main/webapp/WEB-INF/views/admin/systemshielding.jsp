...
<link href="${APP_PATH }/static/manage/static/h-ui/css/H-ui.min.css" rel="stylesheet" type="text/css" />
<link href="${APP_PATH }/static/manage/static/h-ui/css/H-ui.admin.css" rel="stylesheet" type="text/css" />
<link href="${APP_PATH }/static/manage/static/h-ui/css/style.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="${APP_PATH }/static/manage/lib/Validform/5.3.2/Validform.min.js"></script>  
<script type="text/javascript" src="${APP_PATH }/static/manage/lib/layer/1.9.3/layer.js"></script><script type="text/javascript" src="lib/laypage/1.2/laypage.js"></script> 
<script type="text/javascript" src="${APP_PATH }/static/manage/js/H-ui.js"></script> 
<script type="text/javascript" src="${APP_PATH }/static/manage/js/H-ui.admin.js"></script> 
<script type="text/javascript" src="${APP_PATH }/static/manage/js/H-ui.admin.system.js"></script>
